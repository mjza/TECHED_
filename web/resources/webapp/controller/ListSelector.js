sap.ui.define([
		...
		return BaseObject.extend("dommy.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias dommy.model.ListSelector
			 */
			 ...
			 * @return {dommy.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
