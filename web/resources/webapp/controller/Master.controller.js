/*global history */
sap.ui.define([
		"dommy/controller/BaseController",
		...
		"sap/ui/Device",
		"dommy/model/formatter",
		"dommy/model/grouper",
		"dommy/model/GroupSortState"
		...
		return BaseController.extend("dommy.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("dommy.view.ViewSettingsDialog", this);
